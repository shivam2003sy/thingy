      ...
      >
        ...
        <View className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 mb-8 shadow-2xl border-4 border-black/20">
          ...
          <Text className="text-center text-gray-700 font-medium">
            Go viral for your terrible choices
          </Text>
        </View>
        ...
        {/* Subheading */}
        <Text className="text-white text-xl text-center mb-4 opacity-90">
          for Bad Decisions
        </Text>
        ...
        <TouchableOpacity
          onPress={onNext}
          className="bg-gradient-to-r from-lime-400 to-yellow-400 rounded-full px-16 py-5 shadow-lg border-4 border-black/30"
        >
